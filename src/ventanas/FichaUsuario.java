...
public class FichaUsuario extends javax.swing.JFrame {
        ...
        public FichaUsuario() {
                ...
                setSize(650, 430);
                this.setTitle("Gestion de Usuario." + user);
                ...
                lblTitulo.setText("Gestion de Usuario " + user);
        ...
        private void initComponents() {
                ...
                getContentPane().add(txtHowMadeIt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 170, 200, -1));
                ...
                getContentPane().add(botonActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 200, -1));
                ...
                getContentPane().add(botonCambioPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 200, -1));
    ...
    private void botonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarActionPerformed
            ...
            int validacion = 0;
            String nombre, email, phone, username;
                    ...
                    try {
                            ...
                            if (rs.next()) {
                                    ...
                                    try (Connection cn = Conexion.conectar()) {
                                            PreparedStatement pst = cn.prepareStatement(
                                                    "update usuarios set nombre_usuario=?, email=?, telefono=?, username=? where id_usuarios = '" + ID + "'");
